...
p.sw.bifcheck=2; p.sw.spcalc=1;
p.nc.dsmin=0.001;
p.nc.nsteps=5000;p.nc.lammax = 4.0;
...
tic; p=cont(p,100); toc;
%% test bpt
p=swibra('1Dbs','bpt1','tmp',-0.01); p.sw.bifcheck=0; p.sw.spcalc=1; 
p.plot.pmod = 1;
tic; p=cont(p,10); toc
%% test bpt
p=swibra('1Dbs','bpt1','1Dhom',-0.01); p.sw.bifcheck=0; p.sw.spcalc=1; 
p.plot.pmod = 1;
tic; p=cont(p,100); toc
