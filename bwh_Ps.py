...
def update_par():
    par = {'lamb_max' : (dimpar['Lambda_max']*dimpar['nZ'])/dimpar['M0'],
           ...
           'w_wp'     : dimpar['s_wp']*(dimpar['npor']*dimpar['Z']*dimpar['Lambda_max'])/dimpar['M0'],
           'w_fos'    : dimpar['s_fos']*(dimpar['npor']*dimpar['Z']*dimpar['Lambda_max'])/dimpar['M0'],
           'w_fc'     : dimpar['s_fc']*(dimpar['npor']*dimpar['Z']*dimpar['Lambda_max'])/dimpar['M0'],
